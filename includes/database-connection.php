...
$db       = 'jennifer_horoscope';    // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'jennifer_horoscopeadmin';     // Enter YOUR cPanel username and user here
$password = 'HoroscopeA24';           // Enter YOUR user password here                                     
